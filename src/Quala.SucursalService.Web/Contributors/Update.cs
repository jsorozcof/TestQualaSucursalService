...
using Quala.SucursalService.UseCases.Contributors.Get;
using Quala.SucursalService.UseCases.Contributors.Update;
using FastEndpoints;
using MediatR;

namespace Quala.SucursalService.Web.Contributors;
