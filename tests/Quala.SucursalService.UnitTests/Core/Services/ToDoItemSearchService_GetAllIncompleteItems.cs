...
using Quala.SucursalService.Core.ProjectAggregate;
using Quala.SucursalService.Core.Services;
using Quala.SucursalService.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Quala.SucursalService.UnitTests.Core.Services
{
